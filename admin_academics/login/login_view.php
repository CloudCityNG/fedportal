...
<head>
  ...
  <link rel="stylesheet"
        href="<?php echo path_to_link(__DIR__ . '/css/admin-academics-login.min.css', true) ?>"/>
</head>
...
<body class="bg-primary">
  ...
  <script src="<?php echo path_to_link(__DIR__ . '/js/admin-academics-login.min.js', true) ?>"></script>
</body>
