<div class="form-group">
  ...
  <input class="form-control" type="text" name="student_bio[first_name]" id="first-name" required
...
<div class="form-group">
  ...
  <input class="form-control" type="text" name="student_bio[surname]" id="surname" required
         data-fv-stringlength="true" data-fv-stringlength-min="3"/>
</div>
