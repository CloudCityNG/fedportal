...
require_once(__DIR__ . '/helpers/set_student_reg_form_completion_session.php');
...
class EduHistoryController
{
  ...
  public function get()
  {
    ...
    if ($this->edu_history_exists($reg_no)) {
      set_student_reg_form_completion_session('error', 'Record of your education history exists!');
    ...
    include(__DIR__ . '/edu_history_view.php');
  }
