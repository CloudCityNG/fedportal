...
<head>
  ...
  <link rel="stylesheet"
        href="<?php echo STATIC_ROOT . 'admin_finance/login/css/login.css'?>"/>
</head>
    ...
    <section class="panel" style="background-color: inherit">
      ...
      <div class="row sign-in-container">
        <form class="form-inline sign-in-form col-sm-8" id="sign-in-form" data-toggle="validator">
          <span class="legend">Admin Finance Login</span>
...
<script src="<?php echo STATIC_ROOT . 'admin_finance/login/js/login.js'?>"></script>
</body>
